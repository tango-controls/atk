...
// By:            <assum@esrf.fr>
// Time-stamp:    <2002-07-01 16:53:28, assum>
// 
// $Id$
// 
// Description:       
...
public class DeviceFactory implements IRefreshee, java.io.Serializable {
	...
	ATKLogger.getInstance(DeviceFactory.class.getName());
     ...
     * for the Device, which runs at Thread.MAX_PRIORITY, and sleeps
     * for refreshInterval seconds.
