...
//System.out.println("NumberScalar.refresh() called for : "+getName());
...
//System.out.println("NumberScalar.change() called for : " + getName() );
      trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.change method called for " + getName(), t0);
      
      try
      {
	  da = evt.getValue();
          trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.changeEvt.getValue(" + getName() + ") success", t0);
      }
      catch (DevFailed  dfe)
      {
//System.out.println("NumberScalar.change() caught DevFailed for : " + getName());
	  trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.changeEvt.getValue(" + getName() + ") failed, caught DevFailed", t0);
          if (dfe.errors[0].reason.equals("API_EventTimeout")) //heartbeat error
	  {
//System.out.println("NumberScalar.change() caught heartbeat DevFailed : " + getName());
	      trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.changeEvt.getValue(" + getName() + ") failed, got heartbeat error", t0);
	      // Tango error
	      scalarValue = Double.NaN;
	      setPointValue = Double.NaN;
	  ...
	  {
//System.out.println("NumberScalar.change() caught other DevFailed : " + getName() );
	      trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.changeEvt.getValue(" + getName() + ") failed, got other error", t0);
	      // Tango error
	      scalarValue = Double.NaN;
	      setPointValue = Double.NaN;
      ...
      {
	  trace(DeviceFactory.TRACE_REFRESHER, "NumberScalar.changeEvt.getValue(" + getName() + ") failed, caught Exception, code failure", t0);
	  scalarValue = Double.NaN;
	  setPointValue = Double.NaN;
