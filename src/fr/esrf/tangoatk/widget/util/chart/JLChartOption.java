...
public class JLChartOption extends JDialog implements ActionListener, MouseListener, ChangeListener, KeyListener {
  ...
  private void initComponents() {
    ...
    generalLabelPLabel.setFont(labelFont);
    generalLabelPLabel.setForeground(fColor);

    generalLabelPCombo = new JComboBox();
    generalLabelPCombo.setFont(labelFont);
    ...
    generalPanel.add(generalLabelPLabel);
    generalPanel.add(generalLabelPCombo);
    ...
    generalLabelPLabel.setBounds(125, 40, 65, 25);
    generalLabelPCombo.setBounds(195, 40, 90, 25);

    generalBackColorLabel.setBounds(10, 70, 140, 25);
    generalBackColorView.setBounds(150, 70, 40, 25);
    generalBackColorBtn.setBounds(195, 70, 40, 25);

    generalGridLabel.setBounds(10, 100, 30, 25);
    generalGridCombo.setBounds(45, 100, 100, 25);
    generalGridStyleLabel.setBounds(150, 100, 40, 25);
    generalGridStyleCombo.setBounds(195, 100, 90, 25);

    generalDurationLabel.setBounds(10, 130, 120, 25);
    generalDurationText.setBounds(135, 130, 150, 25);

    generalFontHeaderLabel.setBounds(10, 160, 80, 25);
    generalFontHeaderSampleLabel.setBounds(95, 160, 145, 25);
    generalFontHeaderBtn.setBounds(245, 160, 40, 25);

    generalFontLabelLabel.setBounds(10, 190, 80, 25);
    generalFontLabelSampleLabel.setBounds(95, 190, 145, 25);
    generalFontLabelBtn.setBounds(245, 190, 40, 25);
    ...
    tabPane.setBounds(5, 5, 300, 245);
    closeBtn.setBounds(225, 255, 80, 25);
    ...
    int y = r.y + (r.height - 315) / 2;
    setBounds(xe, y, 320, 315);
    setResizable(false);
