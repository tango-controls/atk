                                                              ...
                                                              fr.esrf.tangoatk.core.ISetErrorListener
{
	...
	// properly - Erik.
 	...
 	errorTable.getColumnModel().getColumn(ErrorAdapter.TIME).setMaxWidth(66);
 	errorTable.getColumnModel().getColumn(ErrorAdapter.SEVERITY).setMaxWidth(50);
 	errorTable.getColumnModel().getColumn(ErrorAdapter.SOURCE).setMaxWidth(120);
    }
    ...
    private void stopItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stopItemActionPerformed
        // Add your handling code here:
        stopped = true;
        stopButton.setSelected(stopped);
	stopButton.setText("Resume");
