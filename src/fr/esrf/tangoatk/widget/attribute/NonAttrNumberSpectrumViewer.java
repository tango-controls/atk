...
public class NonAttrNumberSpectrumViewer extends JLChart implements INonAttrSpectrumListener {
    ...
    public static void main (String[] args)
    {
        ...
        try
        {
            ...
            IAttribute xattr = (IAttribute)attributelist.add("tango/tangotest/1/double_spectrum_ro");
            IAttribute yattr = (IAttribute)attributelist.add("tango/tangotest/1/float_spectrum_ro");
            final AttrDualSpectrum dual = new AttrDualSpectrum(xattr.getDevice(),xattr.getNameSansDevice(),yattr.getDevice(),yattr.getNameSansDevice());
