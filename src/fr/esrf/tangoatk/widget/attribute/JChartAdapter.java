...
// By:            <assum@esrf.fr>
// Time-stamp:    <2002-07-23 10:28:39, assum>
// 
// $Id$
// 
// Description:       
 ...
 * adapter.setViewer(myJCChart);<br>
...
public class JChartAdapter extends JCDefaultDataSource
	...
	if (refresher == null) {
	    refresher = new Refresher("GraphUpdater");
     ...
     * @param v  Value to assign to viewr.
     * @deprecated use setViewer instead
     */

    public void setViewer(JCChart  v) {
	this.chart = v;
