...
public class Trend extends JPanel implements IControlee, ActionListener, IJLChartActionListener, IRefresherListener {
  ...
  // The models
  fr.esrf.tangoatk.core.AttributePolledList attList = null;
  private TrendSelectionNode lastAdded = null;
  private fr.esrf.tangoatk.core.AttributePolledList lastCreatedList = null;
   ...
   * Trend
   * @param list a <code>fr.esrf.tangoatk.core.AttributePolledList</code> value
   */
  ...
  public void addAttribute(String name) {
    ...
    fr.esrf.tangoatk.core.AttributePolledList alist;

    // Add the attribute in the list
    try {

      if (attList == null) {
        alist = new fr.esrf.tangoatk.core.AttributePolledList();
        alist.add(name);
        setModel(alist);
  ...
  private String applySettings(CfFileReader f) {
    ...
    fr.esrf.tangoatk.core.AttributePolledList alist = new fr.esrf.tangoatk.core.AttributePolledList();
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length > 0) {
      ...
      fr.esrf.tangoatk.core.AttributePolledList lst =
              new fr.esrf.tangoatk.core.AttributePolledList();
      t.setModel(lst);
    }
