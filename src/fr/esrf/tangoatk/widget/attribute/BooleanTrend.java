        ...
        IJLChartActionListener, IRefresherListener
{
    ...
    public static void main (String[] args) throws Exception
    {
        ...
        if ( args.length > 0 )
        {
            ...
            if ( err.length() > 0 )
            {
                JOptionPane.showMessageDialog( null, err, "Errors reading "
        ...
        else
        {
            ...
            AttributePolledList atpl = new AttributePolledList();
	    try
	    {
	       IEntity ie = atpl.add("jlp/test/1/att_boolean");
        ...
        f.pack();
        f.setBounds( framePos.x, framePos.y, frameDimension.x,
                        frameDimension.y );
        f.show();
    } // end of main ()
}
