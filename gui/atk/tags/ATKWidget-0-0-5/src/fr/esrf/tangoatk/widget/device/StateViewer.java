...
public class StateViewer extends javax.swing.JPanel
    ...
    /**
     * Creates a new <code>State</code> instance, and sets up the colors.
     * <code>
     *  colors.put("ALARM", java.awt.Color.orange);
     *  colors.put("ON",    java.awt.Color.green);
     *  colors.put("OFF",   java.awt.Color.white);
     *  colors.put("INSERT", java.awt.Color.red);
     *  colors.put("CLOSE", java.awt.Color.red);
     *  colors.put("EXTRACT", java.awt.Color.red);
     *  colors.put("MOVING", java.awt.Color.blue);
     *  colors.put("STANDBY", java.awt.Color.yellow);
     *  colors.put("FAULT", java.awt.Color.red);
     *  colors.put("INIT", java.awt.Color.magenta);
     *  colors.put("RUNNING", java.awt.Color.red);
     *  colors.put("DISABLE", java.awt.Color.red);
     *  colors.put("UNKNOWN", java.awt.Color.red);
     * </code>
     */
	...
	colors.put("ALARM",   new java.awt.Color(255,140,  0)); // Orange
        ...
        colors.put("INIT",    new java.awt.Color(155, 48,255)); // Purple
	...
	this.state = state;
        valueLabel.setBackground((java.awt.Color)colors.get(state));
    }
