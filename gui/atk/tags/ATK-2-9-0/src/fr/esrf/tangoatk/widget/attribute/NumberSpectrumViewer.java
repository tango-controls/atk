...
public class NumberSpectrumViewer extends JLChart implements fr.esrf.tangoatk.core.ISpectrumListener, IJLChartActionListener, IJLChartListener, JDrawable {
  ...
  String xAxisUnit="";
  String format;
  boolean unitVisible = false;//DO NOT display unit by default for backward compatibility
  final String DISPLAY_UNIT_STRING = "Display/Hide Unit";
   ...
   * @param boolean corresponding to the choice
   */
