...
public class JAutoScrolledText extends JComponent {
    ...
    public JAutoScrolledText() {
      ...
      endFlag = false;
      text = "";
      sizingBehavior = MATRIX_BEHAVIOR;
    }
    
    // Set the sizing behavior
    // CLASSIC_BEHAVIOR will compute font size and return 
    //                  the minimun size to the layout manager
    // MATRIX_BEHAVIOR will not compute font size and let
    //                 the layout manager size the component
