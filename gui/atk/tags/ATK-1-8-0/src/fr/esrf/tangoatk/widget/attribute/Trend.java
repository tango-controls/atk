...
public class Trend extends JPanel implements IControlee, ActionListener, IJLChartActionListener, IRefresherListener {
  ...
  private fr.esrf.tangoatk.core.AttributeList lastCreatedList = null;
  ...
  public void addAttribute(String name) {
    ...
    fr.esrf.tangoatk.core.AttributeList alist;

    // Add the attribute in the list
    try {

      if (attList == null) {
        alist = new fr.esrf.tangoatk.core.AttributeList();
        alist.add(name);
        setModel(alist);
