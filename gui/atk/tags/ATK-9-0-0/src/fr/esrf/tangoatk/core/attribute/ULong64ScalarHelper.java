...
//
// $Id: ULong64ScalarHelper.java 15105 2010-09-24 13:11:54Z poncet $
//
// Description:
...
public class ULong64ScalarHelper extends ANumberScalarHelper {

  public ULong64ScalarHelper(AAttribute attribute) {
    init(attribute);
  }
  ...
  double getNumberScalarValue(DeviceAttribute devAtt) {
    ...
    try {
      long_arr = devAtt.extractULong64Array();
    } catch (DevFailed e) {
      return Double.NaN;
    }
  ...
  protected INumberScalarHistory[] getNumberScalarAttHistory(DeviceDataHistory[] attPollHist) {
    ...
    for (i = 0; i < attPollHist.length; i++) {
      ...
      try {
        long intVal;
        double dblVal;
        intVal = attPollHist[i].extractULong64();
  ...
  public String getVersion() {
    return "$Id: ULong64ScalarHelper.java 15105 2010-09-24 13:11:54Z poncet $";
  }
}
