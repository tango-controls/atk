...
public class TrendSelectionNode extends DefaultMutableTreeNode implements INumberScalarListener {
   ...
   public TrendSelectionNode(JLChart g,String name,INumberScalar model,int selection,Color c) {
     ...
     if( history!=null ) {
       ...
       for(int i=0;i<history.length;i++)
         chart.addData( data , history[i].getTimestamp() , history[i].getValue()  );
     }
   ...
   public void showOptions() {
     ...
     if( data!=null ) {
       JLDataViewOption dlg = new JLDataViewOption(null,chart,data);
       dlg.setVisible(true);
     }
   ...
   public void numberScalarChange(NumberScalarEvent evt) {
	   ...
	   chart.addData( data , (double)evt.getTimeStamp() , evt.getValue() );
   ...
   public void errorChange(ErrorEvent evt) {       
	   ...
	   if( lastErrorTime!=evt.getTimeStamp()  ) {
	     ...
	     chart.addData( data , (double)lastErrorTime , Double.NaN );
