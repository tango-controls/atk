    ...
    switch (orientation) {
      ...
      case VERTICAL_LEFT:
        ...
        if (name != null) {
          ...
          g.drawString(name, (x0 + csize.width) - (int) bounds.getWidth() / 2, y0 - (int) (bounds.getHeight() / 2) - 2);
        }
      ...
      case VERTICAL_RIGHT:
        ...
        if (name != null) {
          Rectangle2D bounds = labelFont.getStringBounds(name, frc);
          g.drawString(name, x0 - (int) bounds.getWidth() / 2, y0 - (int) (bounds.getHeight() / 2) - 2);
        }
