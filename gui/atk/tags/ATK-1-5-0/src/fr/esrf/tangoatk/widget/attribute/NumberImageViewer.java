...
*/
  ...
  private void constructSettingsPanel() {
    ...
    if (settingsDialog == null) {
      ...
      negativeCheck.setBounds(5, 125, 100, 20);
      ...
      snapToGridLabel.setBounds(110, 160, 70, 20);
      settingsPanel.add(snapToGridLabel);

      snapToGridText = new JTextField("");
      snapToGridText.setFont(panelFont);
      snapToGridText.setBounds(185, 160, 50, 20);
      settingsPanel.add(snapToGridText);

      sigHistogramCheck = new JCheckBox("Display only significative data for histogram");
...
//      INumberImage theAtt = (INumberImage) attributeList.add("id14/meteor/1/image");
