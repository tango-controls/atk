...
//
// $Id: ULong64SpectrumHelper.java 15105 2010-09-24 13:11:54Z poncet $
//
// Description:
...
public class ULong64SpectrumHelper extends ANumberSpectrumHelper {

  public ULong64SpectrumHelper(AAttribute attribute) {
    init(attribute);
  }
  ...
  protected INumberSpectrumHistory[] getNumberSpectrumAttHistory(DeviceDataHistory[] attPollHist) {
    ...
    for (i = 0; i < attPollHist.length; i++) {
      ...
      try {
        long[] vals = attPollHist[i].extractULong64Array();
  ...
  double[] getNumberSpectrumValue(DeviceAttribute da) throws DevFailed {
    long[] tmp = da.extractULong64Array();
  ...
  public String getVersion() {
    return "$Id: ULong64SpectrumHelper.java 15105 2010-09-24 13:11:54Z poncet $";
  }
}
